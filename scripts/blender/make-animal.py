...
SPECIES = {
    ...
    "deer": {
        ...
        "parts": [
            ...
            ("head", "cube", (0, 0.76, 1.25), (0.045, 0.075, 0.045)),   # muzzle
            ("head", "cyl", (0.075, 0.58, 1.44), (0.022, 0.022, 0.13)),  # antler beams
            ("head", "cyl", (-0.075, 0.58, 1.44), (0.022, 0.022, 0.13)),
            ("head", "cyl", (0.13, 0.61, 1.50), (0.018, 0.018, 0.08)),   # antler branches
            ("head", "cyl", (-0.13, 0.61, 1.50), (0.018, 0.018, 0.08)),
            ("tail", "cube", (0, -0.46, 0.83), (0.03, 0.09, 0.035)),
        ],
    ...
    "bear": {
        ...
        "parts": [
            ...
            ("head", "cube", (0, 0.77, 0.74), (0.055, 0.07, 0.05)),      # snout
            ("head", "sphere", (0.09, 0.58, 0.92), (0.035, 0.035, 0.035)),  # ears
            ("head", "sphere", (-0.09, 0.58, 0.92), (0.035, 0.035, 0.035)),
    ...
    "rabbit": {
        ...
        "parts": [
            ...
            ("head", "cube", (0, 0.28, 0.35), (0.03, 0.04, 0.028)),      # muzzle
            ("head", "cube", (0.032, 0.16, 0.50), (0.018, 0.028, 0.10)), # ears
            ("head", "cube", (-0.032, 0.16, 0.50), (0.018, 0.028, 0.10)),
            ("tail", "sphere", (0, -0.24, 0.29), (0.032, 0.038, 0.032)),
        ],
