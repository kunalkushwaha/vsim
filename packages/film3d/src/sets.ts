...
export function weather(b: SceneBuilder, kind: "snowfall" | "rain" | "fireflies" | "leaves"): void {
  const presets = {
    ...
    rain: { position: [0, 9, -3], spread: [14, 1, 10], count: 1300, velocity: [0.4, -10.5, 0], velocitySpread: [0.3, 1.4, 0.3], gravity: [0, 0, 0], lifeFrames: 34, size: 0.013, color: [0.55, 0.62, 0.75], opacity: 0.3, streak: 0.045 },
